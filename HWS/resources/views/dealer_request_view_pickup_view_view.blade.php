        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb">Pick-Up Dealer Request Details</h4> 

                 <form class="form-horizontal" method="POST" action="{{ URL::asset('delaer_ship_req_sub') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    <input type="hidden" name="ticket_id" value="<?php echo"$requested_id"; ?>">
                        ...
                        <table class="table">
                           ...
                           <!--  <tr>
                               <td>Shipper Remarks</td><td colspan="3">
                               <textarea rows="4" cols="" name="ship_remarks" class='form-control' required></textarea>
                               </td>
                            </tr> -->
