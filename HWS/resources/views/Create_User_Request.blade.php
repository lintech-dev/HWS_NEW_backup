         ...
         <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>Create a Request</h4> 

                
                
                    
                     <form class="form-horizontal" method="POST" action="user_request_back" enctype="multipart/form-data">
                        {{ csrf_field() }}
