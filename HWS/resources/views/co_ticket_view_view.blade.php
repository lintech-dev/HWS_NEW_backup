         ...
         <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i><?php echo"$status"; ?> Request Detail View</h4> 
...
<option value="<?php echo"On Progress"; ?>"><?php echo"On Progress"; ?></option>
<option value="<?php echo"Closed"; ?>"><?php echo"Closed"; ?></option>
<option value="<?php echo"New"; ?>"><?php echo"New"; ?></option>
<option value="<?php echo"Escalated"; ?>"><?php echo"Escalated"; ?></option>
<option value="<?php echo"Shipped"; ?>"><?php echo"Shipped"; ?></option>
</select>
</td>
</tr>
