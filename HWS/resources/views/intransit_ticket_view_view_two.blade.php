         ...
         <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>In-Transit Detail View of Pick-Up Ticket</h4> 
...
<form class="form-horizontal" method="POST" action="{{ URL::asset('ticket_shipper_close_two') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
...
<tr>
<td>Shipper Remkars</td><td colspan="3">
<textarea rows="4" cols="55" name="shipper_remarks" class='form-control'></textarea></td>
</td>
</tr>
